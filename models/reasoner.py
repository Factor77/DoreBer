...
from models.bernnet_with_fx_relu import BernConvLayer
...
class DynamicReasoner(nn.Module):
    def __init__(self, hidden_size, gcn_layer, dropout_gcn):
        ...
        self.bernnet = BernConvLayer(self.hidden_size, self.gcn_layer, self.dropout_gcn, K=100) 
    def forward(self, input):
        ...
        '''Perform reasoning'''
        output = self.bernnet(att[:, :, 1:], input)
        return output
